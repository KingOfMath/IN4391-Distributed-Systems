...
class BlockSpec extends AnyFlatSpec with Matchers {
  ...
  "Adding transaction" should "increase length of transaction array" in {
    ...
    val t = new Transaction(Operation.transfer, "a", Some("b"), immutable.Seq[String](), immutable.Seq[String](),1, app)
  ...
  "Tostring identical blocks" should "return same string" in {
    ...
    val t2 = new Transaction(Operation.transfer, "a", Some("b"), immutable.Seq[String](), immutable.Seq[String](),1, app)
