...
class GraphSpec extends AnyFlatSpec with Matchers {
  ...
  "Graph" should "be able to contain vertices" in {
    ...
    val t_1 = new Transaction(Operation.transfer, "a", Some("b"), immutable.Seq[String](), immutable.Seq[String](),1, app)
    val t_2 = new Transaction(Operation.transfer, "a", Some("c"), immutable.Seq[String](), immutable.Seq[String](),1, app)
    val t_3 = new Transaction(Operation.transfer, "c", Some("b"), immutable.Seq[String](), immutable.Seq[String](),1, app)
    g.addEdge(t_1, t_2)
    g.addEdge(t_2, t_3)
    g.addEdge(t_1, t_3)
    g.addEdge(t_1, t_3)
  ...
  "Graph" should "return correct predecessors" in {
    ...
    val t_4 = new Transaction(Operation.transfer, "d", Some("e"), immutable.Seq[String](), immutable.Seq[String](),1, app)
