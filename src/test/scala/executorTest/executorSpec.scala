...
class executorSpec extends FlatSpec with Matchers {
  ...
  "Executor" should "be able to add block" in {
    ...
    val transaction1 = new Transaction(Operation.set, "test1", None, immutable.Seq[String](), immutable.Seq("test1"), 2, Application.A)
    val transaction2 = new Transaction(Operation.transfer, "test1", Some("test2"), immutable.Seq("test1", "test2"), immutable.Seq("test2"), 1, Application.A)
  ...
  "Executor" should "set balances correctly" in {
    ...
    val new_block = new BlockChainBlock(Config.genesisBlock.hash(), Config.genesisBlock.getSequenceId + 1)
    val transaction1 = new Transaction(Operation.set, "test1", None, immutable.Seq[String](), immutable.Seq("test1"), 2, Application.A)
    val transaction2 = new Transaction(Operation.set, "test1", None, immutable.Seq[String](), immutable.Seq("test1"), 1, Application.A)
    new_block.addTransaction(transaction1)
    new_block.addTransaction(transaction2)
    val depGraph = new DependencyGraph(Config.genesisBlock.getSequenceId + 1)
    depGraph.addEdge(transaction1, transaction2)
  ...
  "Executor" should "should only execute transactions corresponding with their Applications" in {
    ...
    val new_block = new BlockChainBlock(Config.genesisBlock.hash(), Config.genesisBlock.getSequenceId + 1)
    val transaction1 = new Transaction(Operation.set, "test1", None, immutable.Seq[String](), immutable.Seq("test1"), 2, Application.A)
    val transaction2 = new Transaction(Operation.set, "test1", None, immutable.Seq[String](), immutable.Seq("test1"), 1, Application.B)
    new_block.addTransaction(transaction1)
    new_block.addTransaction(transaction2)
    val depGraph = new DependencyGraph(Config.genesisBlock.getSequenceId + 1)
    depGraph.addEdge(transaction1, transaction2)
  ...
  "Executor" should "execute transactions in the correct order when dependencies exist" in {
    ...
    val new_block = new BlockChainBlock(Config.genesisBlock.hash(), Config.genesisBlock.getSequenceId + 1)
    val transaction1 = new Transaction(Operation.set, "test1", None, immutable.Seq[String](), immutable.Seq("test1"), 2, Application.A)
    val transaction2 = new Transaction(Operation.set, "test2", None, immutable.Seq[String](), immutable.Seq("test2"), 1, Application.A)
    val transaction3 = new Transaction(Operation.transfer, "test2", Option("test1"), immutable.Seq("test2", "test1"),
